...
💡 **Notice**: Larger samples give narrower (more precise) intervals.
...
💡 **Advice**: Bootstrap methods give slightly different results on the same data in different runs due to their random nature. For reproducibility, set a random seed using `set.seed()`{.r} before calling `ci_boot()`{.r}.
